...
vi.mock('./views/finance.js', () => ({ default: class { setReplaceTitleSponsorHandler() {} setReplaceTyreSupplierHandler() {} render(...args) { viewFns.financeRender(...args); } } }));

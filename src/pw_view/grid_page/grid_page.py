...
class GridPage(ft.Column):
	...
	def show_staff_grid(self) -> None:
		...
		self.grid_this_year_table.assign_on_tap_callback(2, self.driver_column_clicked)
		self.grid_this_year_table.assign_on_tap_callback(3, self.driver_column_clicked)
		# self.grid_this_year_table.content.content = self.grid_this_year_table.list_view
		...
		self.grid_next_year_table.update_table_data(self.grid_next_year_announced_df.values.tolist(),
													team_logo_col_idx=0, team_logos=self.team_names)
		self.grid_next_year_table.assign_on_tap_callback(2, self.driver_column_clicked)
		self.grid_next_year_table.assign_on_tap_callback(3, self.driver_column_clicked)

...
def create_schema(conn):
    ...
    c.execute(
        ...
        CREATE TABLE IF NOT EXISTS drivers (
            ...
            qualifying INTEGER DEFAULT 3,
            racecraft INTEGER DEFAULT 3,
    ...
    c.execute(
        ...
        CREATE TABLE IF NOT EXISTS teams (
            ...
            title_sponsor_contract_length INTEGER DEFAULT 0,
    ...
    if "qualifying" not in driver_columns:
        c.execute("ALTER TABLE drivers ADD COLUMN qualifying INTEGER DEFAULT 3")
    if "racecraft" not in driver_columns:
        c.execute("ALTER TABLE drivers ADD COLUMN racecraft INTEGER DEFAULT 3")
    ...
    if "commercial_staff" not in team_columns:
        c.execute("ALTER TABLE teams ADD COLUMN commercial_staff INTEGER DEFAULT 0")
    ...
    if "title_sponsor_contract_length" not in team_columns:
        c.execute("ALTER TABLE teams ADD COLUMN title_sponsor_contract_length INTEGER DEFAULT 0")
    ...
    if "tyre_supplier_contract_length" not in team_columns:
        c.execute("ALTER TABLE teams ADD COLUMN tyre_supplier_contract_length INTEGER DEFAULT 0")
    ...
    if "factory_overhead_yearly" not in team_columns:
        c.execute("ALTER TABLE teams ADD COLUMN factory_overhead_yearly INTEGER DEFAULT 0")
